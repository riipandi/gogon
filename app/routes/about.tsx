    ...
    <main className="page-wrap px-4 py-12">
      <section className="island-shell rounded-2xl p-6 sm:p-8">
        ...
        <p className="m-0 max-w-3xl text-base leading-8 text-(--sea-ink-soft)">
          This starter combines Chi router for the backend, React with TanStack Router
          for the frontend, and a Vite plugin that handles the entire Go build
          pipeline — including embedding the SPA into a single binary.
        </p>
        <div className="mt-6">
          <Link
            to="/"
